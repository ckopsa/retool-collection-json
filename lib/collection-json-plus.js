...
var MyCustomComponent = function MyCustomComponent(_ref) {
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    className: "col"
  }, model.cj.collection.items.map(function (it) {
    return /*#__PURE__*/React.createElement("div", {
      ...
      className: "card-body"
    }, it.links && it.links.map(function (itLink, i) {
    ...
    className: "col"
  }, model.cj.collection.queries.map(function (query) {
    return queryToComponent(query, httpQuery);
  }), model.cj.collection.commands.map(function (command) {
